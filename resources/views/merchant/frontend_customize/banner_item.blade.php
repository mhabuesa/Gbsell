                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-4">
                                                            <div class="mb-4">
                                                                ...
                                                                <input type="text" class="form-control w-100" name="subtitle" id="subtitle" required>
                                                                @error('subtitle')
                                                                    <small class="text-danger">{{ $message }}</small>
                                                                @enderror
                                                            </div>
                                                        ...
                                                        <div class="col-lg-4">
                                                            <div class="mb-4">
                                                                ...
                                                                <select class="js-select2 form-select" id="one-ecom-product-category" name="product_id" data-placeholder="Choose one.." required>
                                                                    <option></option>
                                                        ...
                                                        @foreach ($banners as $banner)
                                                            <tr>
                                                                ...
                                                                <td class="text-center">
                                                                    <div class="btn-group">
                                                                        <a class="btn btn-sm btn-alt-secondary js-bs-tooltip-enabled" href="{{ route('front.banner.item.edit', $banner->id) }}" >
                                                                            <i class="fa fa-fw fa-pencil-alt"></i>
                                                                        </a>
                                                                        <button type="button" class="btn btn-sm btn-alt-secondary js-bs-tooltip-enabled" onclick="deleteBanner(this)"
                                                                            data-id="{{ $banner->id }}">
