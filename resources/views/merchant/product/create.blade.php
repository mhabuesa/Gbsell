                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <div class="mb-4 p-3 border border-gray-300">
                                        <div class="mb-2">
                                            <label class="form-label mb-0" for="js-ckeditor5-classic">Product
                                                Variant</label>
                                            <small class="d-block mb-2">You can add multiple variants for a single product
                                                here. Like Size, Color, and Weight etc.</small>
                                        </div>
                                        ...
                                        <div class="mb-3 mt-3">
                                            <div class="row" id="variants">
                                                <div class="col-sm-12 variant-options-container">
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="col-lg-2 col-4">
                                                            <div class="mb-4">
                                                                <label class="form-label"
                                                                    for="one-ecom-extra-price">Current Price</label>
                                                                <div class="d-flex">
                                                        ...
                                                        <div class="col-lg-2 col-6">
                                                            <div class="mb-4">
                                                                <label class="form-label"
                                                                    for="one-ecom-extra-price">Regular Price</label>
                                                                <div class="d-flex">
                                                                    <input type="number" class="form-control"
                                                        ...
                                                        <div class="col-lg-2 col-6">
                                                            <div class="mb-4">
                                                                <label class="form-label"
                                                                    for="one-ecom-extra-price">Quentity (Stock)</label>
                                                                <div class="d-flex">
                                                                    <input type="number" class="form-control"
                                                                        name="quantity[]" placeholder="Quentity" required>
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="mb-4">
                                                        <button id="add-more-option" class="btn btn-primary mt-2"
                                                            type="button">
