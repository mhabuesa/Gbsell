    ...
    <div class="content-header">
      <div class="">
        <div class="d-flex align-items-center">
            <h3 class="mt-1 mb-0"><strong>{{Auth::guard('merchant')->user()->shop->name}}</strong></h3>
        </div>
        <small class=" fs-9 fw-medium text-muted">{{Auth::guard('merchant')->user()->shop->created_at ->format('D j, M Y') }}</small>
      </div>
      <div class="d-flex align-items-center">
        <div class="dropdown d-inline-block ms-2">
          <button type="button" class="btn btn-sm btn-alt-secondary d-flex align-items-center" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            ...
            @else
                <img class="rounded-circle" src="{{ asset(Auth::guard('merchant')->user()->photo)}}" alt="photo" style="width: 21px;">
            @endif
          ...
          <div class="dropdown-menu dropdown-menu-md dropdown-menu-end p-0 border-0" aria-labelledby="page-header-user-dropdown">
            <div class="p-3 text-center bg-body-light border-bottom rounded-top">
                ...
                @else
                    <img class="img-avatar img-avatar48 img-avatar-thumb" src="{{ asset(Auth::guard('merchant')->user()->photo)}}" alt="">
                @endif
