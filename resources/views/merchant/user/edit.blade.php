@push('title')
    <title>User Edit | GBSell - eCommerce Solution </title>
@endpush
@push('style')
        ...
        <div class="content content-boxed">
            <div class="block block-rounded">
                <div class="block-header block-header-default">
                    <h3 class="block-title">Edit User & Permission</h3>
                                ...
                                <form action=" {{ route('user.update', $user->id) }} " method="POST">
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <select class="form-select" id="permission" name="permission">
                                            ...
                                            <option {{ $user->permission == 2 ? 'selected' : '' }} value="2">Admin
                                            </option>
                                            <option {{ $user->permission == 3 ? 'selected' : '' }} value="3">Moderator
                                            </option>
                                            <option {{ $user->permission == 4 ? 'selected' : '' }} value="4">Editor
                                            </option>
                                        </select>
                                        @error('permission')
                                            <small class="text-danger">{{ $message }}</small>
