                ...
                <div class="block-header block-header-default">
                    ...
                    <div class="block-options">
                        <div class="block-options-item">
                          <a href="{{ route('user.index') }}" class="btn btn-sm btn-primary"> <i class="fa fa-arrow-left"></i> Back to List</a>
                        </div>
                      </div>
                </div>
                            ...
                            <div class="card-body">
                                <form action=" {{ route('user.store') }} " method="POST">
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <div class="password-container d-flex">
                                            <input type="password" class="form-control password-input" id="password_confirmation" name="password_confirmation" placeholder="Confirm Password">
