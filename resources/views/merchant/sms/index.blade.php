                              ...
                              <div class="form-check form-block">
                                ...
                                <label class="form-check-label" for="cod_input">
                                    <span class="d-flex align-items-center">
                                      <img class="img-avatar img-avatar48" src="http://127.0.0.1:8000/assets/media/photos/sms.png" alt="Cash on Delivery">
                                      <span class="ms-2">
                                ...
                                <form action="{{ route('sms.update', $shop_id) }}" method="POST">
                                    ...
                                    <div class="row">
                                        <div class="mb-3">
                                            ...
                                            <small>To enable Bulk SMS messaging, please create an account on <span><a href="https://www.bulksmsbd.com" target="_blank">BULK SMS BD</a></span>.</small>
                                            <small class="d-block">Once you've obtained your credentials, integrate them into your system to start using the Bulk SMS service.</small>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="mb-2">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-2">
                                                ...
                                                <input type="text" class="form-control" id="sender_id" name="sender_id" value="{{ $sender_id }}">
                                                    @error('sender_id')
                                                        <span class="text-danger">{{$message}}</span>
                                                    @enderror
                                            </div>
                                    ...
                                    <div class="mb-4">
                                        <div class="form-check form-switch form-check-inline">
                                            <input class="form-check-input" {{ $status == '1' ? 'checked' : '' }} type="checkbox" id="status" name="status">
                                            <label class="form-check-label" for="status">Availability</label>
                                        </div>
                                    </div>
                                    <div class="mb-2">
                                        <button type="submit" class="btn btn-alt-primary">{{ $api_key ? 'Update' : 'Submit' }}</button>
                                    </div>
                                </form>
                            </div>
                        </div>
