@push('title')
    <title>Complate Order List | GBSell - eCommerce Solution </title>
@endpush
@push('style')
    <style>
        .dt-length,
            ...
            <div class="col-md-7 col-xl-9">
                <div class="block block-rounded">
                    <div class="block-header block-header-default">
                        <h3 class="block-title">Complate Order List</h3>
                                ...
                                <tbody>
                                    @foreach ($orders as $key => $order)
                                        <tr class="hover_tr">
                                            ...
                                            <td class="fs-sm fw-semibold text-center text-success">
                                                {{ $order->tracking_code }}
                                            </td>
                                            <td class="fs-sm">
                                                {{ $order->customer->name }}
