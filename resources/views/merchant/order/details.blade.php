    ...
    <div class="content">
        ...
        <div class="block block-rounded">
            ...
            <div class="block-content block-content-full overflow-x-auto">
                    ...
                    @if ($redx)
                        <div class="col-md-2">
                            <div class="form-check form-block">
                                <input class="form-check-input" checked type="radio" id="redx_input" name="delivery">
                                <label class="form-check-label" for="redx_input">
                                    <span class="d-flex align-items-center">
                                        <img class="img-avatar img-avatar48"
                                            src="http://127.0.0.1:8000/assets/media/photos/redx.png" alt="Redx Delivery">
                                        <span class="ms-2">
                ...
                <div class="modal steadfast" id="steadfast" tabindex="-1" aria-labelledby="steadfast"
                    style="display: none;" aria-hidden="true">
                                        ...
                                        <form action="{{ route('steadfast.delivery') }}" method="POST">
                                            ...
                                            <div class="col-6 col-md-12">
                                                <div class="mb-2">
                                                    ...
                                                    <input type="text" class="form-control w-50" name="invoice"
                                                        readonly value="{{ $order->order_id }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-6 col-md-6">
                                                <div class="mb-2">
                                                    ...
                                                    <input type="text" class="form-control" name="recipient_name"
                                                        readonly value="{{ $order->shipping->ship_name }}">
                                                </div>
                                            </div>
                                            <div class="col-6 col-md-6">
                                                <div class="mb-2">
                                                    ...
                                                    <input type="text" class="form-control" name="recipient_phone"
                                                        readonly value="{{ $order->shipping->ship_phone }}">
                                                </div>
                                            </div>
                                            <div class="col-6 col-md-12">
                                                <div class="mb-2">
                                                    ...
                                                    <input type="text" class="form-control" name="recipient_address"
                                                        readonly value="{{ $order->shipping->ship_address }}">
                                                </div>
                                            </div>
                                            <div class="col-6 col-md-12">
                                                <div class="mb-2">
                                                    <label class="form-label fs-sm mb-0">*Amount to Collect</label>
                                                    <input type="text" class="form-control" name="cod_amount" readonly
                                                        value="{{ $order->total }}">
                                                </div>
                                            </div>
