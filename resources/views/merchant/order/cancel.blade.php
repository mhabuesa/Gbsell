@push('title')
    <title>Cancelled Order List | GBSell - eCommerce Solution </title>
@endpush
@push('style')
    <style>
        .dt-length,
                ...
                <div class="col-md-7 col-xl-9 p-0">
                    <div class="block block-rounded">
                        <div class="block-header block-header-default">
                            <h3 class="block-title">Cancelled Order List</h3>
                        ...
                        <div class="block-content">
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover table-sm table-vcenter js-dataTable-responsive" id="userTable">
                                    <thead>
                                        <tr>
