            ...
            <div class="block block-rounded">
                ...
                <div class="block-content">
                    <div class="row d-flex justify-content-center">
                        ...
                        <div class="col-6 col-lg-3">
                            <a class="block block-rounded block-link-shadow text-center" href="{{ $shop->url }}"
                                target="_blank">
                                <div class="block-content block-content-full">
                                    <div id="qr-code-placeholder" class="fs-2 fw-semibold text-dark">
                                        <!-- Placeholder image initially -->
                                        <img src="{{ asset('assets') }}/media/photos/img.png" width="70"
                        ...
                        <div class="col-md-10 col-lg-8">
                            <form action="{{ route('shop.update', $shop->id) }}" method="POST"
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            ...
                                            <select name="shop_type" id="" class="form-control" required>
                                                ...
                                                <option {{ $shop->type == 'Utilities' ? 'selected' : '' }}
                                ...
                                <div class="mb-4">
                                    ...
                                    <input class="form-control" id="logo" type="file" accept="image/*"
                                        name="logo"
