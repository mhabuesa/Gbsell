                                        ...
                                        <form class="js-validation-signup" action="{{ route('shop.store') }}" method="POST">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="mb-4">
                                                        ...
                                                        <input type="text"
                                                            class="form-control"
                                                            id="shop_name" name="shop_name" placeholder="Shop name" value="{{ old('shop_name') }}" required>
                                                        @error('shop_name')
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="mb-4">
                                                        ...
                                                        <input type="number"
                                                            class="form-control"
                                                            id="shop_phone" name="shop_phone" placeholder="Phone number" value="{{ old('shop_phone') }}" required>
                                                        @error('shop_phone')
                                                            <small class="text-danger px-2">{{ $message }}</small>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="mb-4">
                                                        ...
                                                        <input type="email"
                                                            class="form-control"
                                                            id="shop_email" name="shop_email" placeholder="Phone email" value="{{Auth::guard('merchant')->user()->email}}" readonly="" >
                                                        @error('shop_email')
                                                            <small class="text-danger px-2">{{ $message }}</small>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="mb-4">
                                                        ...
                                                        <select class="js-select2 form-select" id="one-ecom-product-category" name="shop_city" style="width: 100%;" data-placeholder="Choose one..">
                                                          <option></option>
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="mb-4">
                                                        ...
                                                        <input type="text"
                                                            class="form-control"
                                                            id="shop_address" name="shop_address" placeholder="Shop Address" value="{{ old('shop_address') }}" required>
                                                        @error('shop_address')
                                                            <small class="text-danger px-2">{{ $message }}</small>
                                                        @enderror
                                                    </div>
                                            ...
                                            <div class="text-center">
                                                <button type="submit" class="btn btn-lg btn-alt-success">
                                                    <i class="fa fa-fw fa-shop me-2 opacity-50"></i>Shop Create in a few moments
                                                </button>
                                            </div>
                                        </form>
                                    </div>
