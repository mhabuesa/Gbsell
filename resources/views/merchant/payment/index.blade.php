            ...
            <div class="block-content">
                <div class="col-lg-8 m-auto ">
                    <div class="row items-push">
                                ...
                                <label class="form-check-label" for="cod_input">
                                    <span class="d-flex align-items-center">
                                        <img class="img-avatar img-avatar48"
                                            src="http://127.0.0.1:8000/assets/media/photos/cod.png" alt="Cash on Delivery">
                                        <span class="ms-2">
                        ...
                        <div class="col-md-4">
                            <div class="form-check form-block">
                                <input class="form-check-input" {{ $ssl && $ssl->status == 1 ? 'checked' : '' }}
                                    type="checkbox" value="" id="ssl_input" name="ssl_input">
                                <label class="form-check-label" for="ssl_input">
                                    <span class="d-flex align-items-center">
                                        <img class="img-avatar img-avatar48"
                                            src="{{ asset('assets') }}/media/photos/sslcommerz.png" alt="">
                                        <span class="ms-2">
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            <form action="{{ route('payment.cod', $shop_id) }}" method="POST">
                                ...
                                <div class="mb-2">
                                    <button type="submit"
                                        class="btn btn-alt-primary">{{ $cod ? 'Update' : 'Submit' }}</button>
                                </div>
                            </form>
                        </div>
                    </div>
                            ...
                            <form action="{{ route('payment.ssl', $shop_id) }}" method="POST">
                                ...
                                <div class="row">
                                    <div class="mb-3">
                                        ...
                                        <small>To get online payment please configure SSL Commerz. Dont't have SSL Commerz
                                            account? <span class="text-primary text-decoration-underline fs-6"><a
                                                    href="https://join.sslcommerz.com/" target="_blank">Apply
                                                    Now</a></span></small>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="mb-2">
                                            ...
                                            <input type="text" class="form-control" id="store_id" name="store_id"
                                                value="{{ $ssl && $ssl->store_id ? $ssl->store_id : '' }}">
                                            @error('store_id')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-2">
                                            ...
                                            <input type="text" class="form-control" id="store_password"
                                                name="store_password"
                                                value="{{ $ssl && $ssl->store_password ? $ssl->store_password : '' }}">
                                ...
                                <div class="mb-4">
                                    <div class="form-check form-switch form-check-inline">
                                        <input class="form-check-input" type="checkbox"
                                            {{ $ssl && $ssl->status == 1 ? 'checked' : '' }} id="status"
                                            name="status">
                                        <label class="form-check-label" for="status">Availability</label>
                                    </div>
                                    <div class="form-check form-switch form-check-inline">
                                        <input class="form-check-input danger_inpit" type="checkbox"
                                            {{ $ssl && $ssl->sendbox_status == 1 ? ' ' : 'checked' }} id="status"
                                            name="sendbox_status">
                                ...
                                <div class="mb-2">
                                    <button type="submit"
                                        class="btn btn-alt-primary">{{ $ssl ? 'Update' : 'Submit' }}</button>
                                </div>
                            </form>
                        </div>
                    </div>
