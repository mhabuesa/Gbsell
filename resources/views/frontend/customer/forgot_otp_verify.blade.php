            ...
            <div class="my-4 my-xl-8">
                <div class="row">
                    <div class="col-md-5 mb-8 mb-md-0 m-auto">
                        <form action="{{ route('forget.new.password', ['shopUrl' => $shop->url, 'phone' => $phone]) }}" class="js-validate" novalidate="novalidate" method="POST">
                            @csrf
                            <!-- Form Group -->
                            <div class="js-form-message form-group">
                                ...
                                <input type="number" class="form-control" name="otp" id="otp" placeholder="123456"
                                    aria-label="123456" required="" data-msg="Please enter a valid OTP Code."
