...
footer {
  ...
  <body>
    ...
    @php
        ...
        $shop = App\Models\Shop::where('shop_id', $order->shop_id)->first();
    ...
    <header class="clearfix">
      <div id="logo">
        <img width="100" src="{{ asset($shop->logo)}}">
      </div>
      <div id="company">
    ...
    <main>
      <div id="details" class="clearfix">
        <div id="client">
          <div>
            ...
            <div class="address">{{ $bill->address }}, {{ $bill->city }}, Bangladesh</div>
            <div class="email"><a href="mailto:{{ $bill->email }}">{{ $bill->email }}</a></div>
          </div>
          <br>
          <div>
            <div class="to">Shipped TO:</div>
            <h2 class="name">{{ $ship->ship_name }}</h2>
            <div class="address">{{ $ship->ship_address }}, {{ $ship->ship_city }}, Bangladesh</div>
      ...
      <table border="0" cellspacing="0" cellpadding="0">
        ...
        @foreach ($orderproducts as $sl=>$orderproduct)
          <tr>
            <td class="no">{{ $sl+1 }}</td>
            <td class="desc">{{ $orderproduct->products->name }}</td>
