                    ...
                    <div class="d-flex align-items-center">
                        <div class="topbar-left">
                            <ul class="list-inline mb-0">
                                ...
                                <li
                                    class="list-inline-item u-header-topbar__nav-item u-header-topbar__nav-item-no-border">
                            ...
                            <form class="js-focus-state" action="{{ route('searchAll') }}">
                                ...
                                <div class="input-group">
                                    <input type="search"
                                        ...
                                        name="q" id="searchproduct-item" placeholder="Search for Shop or Product"
                                        aria-label="Search for products" aria-describedby="searchProduct1" value="{{ request('q') }}">
                                ...
                                <ul class="d-flex list-unstyled mb-0">
                                    ...
                                    <li class="col d-xl-none px-2 px-sm-3 position-static">
                                        ...
                                        <div id="searchClassic"
                                            ...
                                            <form class="js-focus-state input-group px-3" action="{{ route('searchAll') }}" method="GET">
                                                <input class="form-control" type="search"
                                                    placeholder="Search Shop or Product" name="q" value="{{ request()->q }}" aria-label="Search Shop or Product">
                                                <div class="input-group-append">
